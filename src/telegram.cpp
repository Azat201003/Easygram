...
private:
  ...
  auto create_authentication_query_handler(string *error) {
    return [this, id = authentication_query_id_, error](Object object) {
      logger->named<TdManager>("authentication_query_handler\n");
...
//                             td_api::make_object<td_api::chatListMain>(), 10000),
//                         [this](Object object) {
//                           if (object->get_id() == td_api::error::ID) {
//                             return;
//                           }
                           ////this->chats_[object->] =
                           ////   td::move_tl_object_as<td_api::chat>(
                           ////            object);
                           //for (auto chat_id :
...
//                         });
  ...
  void process_response(td::ClientManager::Response response) {
    ...
    logger->named<TdManager>(response.request_id + " " +
        ...
        *update,
        overloaded(
            ...
            [this](td_api::updateNewMessage &update_new_message) {
              ...
              //                         overloaded(
              //                             [this,
              //                             &sender_name](td_api::messageSenderUser
              //                             &user) { sender_name =
              //                             get_user_name(user.user_id_);
              //                             },
              //                             [this,
              //                             &sender_name](td_api::messageSenderChat
              //                             &chat) { sender_name =
              //                             get_chat_title(chat.chat_id_);
              //                             }));
              std::string text;
